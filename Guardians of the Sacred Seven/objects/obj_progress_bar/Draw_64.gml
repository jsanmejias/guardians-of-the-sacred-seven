...
draw_set_font(fnt_default); // Use the default font
draw_set_color(c_white); // Set the text color to white
draw_text_transformed(room_width / 2 + 10, room_height - 718, string(floor(global.counter)), 2, 2, 0); // Scale text by 2x
